        ...
        <div class="row justifly-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#tambahProductModal"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($product->photo !== null)
                                                <img src="{{ asset('storage/photo_product/' . $product->photo) }}"
                                                    width="50px">
                                            @else
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="basic example">
                                                ...
                                                <button type="button" id="btn-delete-product" class="btn btn-danger"
                        ...
                        <div class="form-group">
                            ...
                            <select id="brands_id" class="form-control" name="brands_id">
                                @foreach ($brands as $brand)
                                    <option class="form-control" name="brands_id" value="{{ $brand->id }}">
                                        {{ $brand->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select id="categories_id" class="form-control" name="categories_id">
                                @foreach ($categories as $categorie)
                                    <option name="categories_id" value="{{ $categorie->id }}">{{ $categorie->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="edit-categories_id" class="form-control" name="categories_id">
                                        @foreach ($categories as $categorie)
                                            <option name="categories_id" value="{{ $categorie->id }}">
